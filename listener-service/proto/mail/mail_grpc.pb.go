...
type MailServiceClient interface {
	SendWelcomeMail(ctx context.Context, in *SendWelcomeMailRequest, opts ...grpc.CallOption) (*SendWelcomeMailResponse, error)
}
...
func (c *mailServiceClient) SendWelcomeMail(ctx context.Context, in *SendWelcomeMailRequest, opts ...grpc.CallOption) (*SendWelcomeMailResponse, error) {
	out := new(SendWelcomeMailResponse)
	err := c.cc.Invoke(ctx, "/mail.MailService/SendWelcomeMail", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MailServiceServer interface {
	SendWelcomeMail(context.Context, *SendWelcomeMailRequest) (*SendWelcomeMailResponse, error)
...
func (UnimplementedMailServiceServer) SendWelcomeMail(context.Context, *SendWelcomeMailRequest) (*SendWelcomeMailResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SendWelcomeMail not implemented")
}
...
func _MailService_SendWelcomeMail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SendWelcomeMailRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MailServiceServer).SendWelcomeMail(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mail.MailService/SendWelcomeMail",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MailServiceServer).SendWelcomeMail(ctx, req.(*SendWelcomeMailRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _MailService_SendWelcomeMail_Handler,
		},
	},

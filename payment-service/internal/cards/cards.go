...
// Gets the payment method (includes last four digits and exp date of the card) using payment intent id
...
// Gets an existing payment intent using id
...
// Subscribes a stripe customer to a stripe plan

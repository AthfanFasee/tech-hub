...
type UserServiceClient interface {
	...
	Activate(ctx context.Context, in *ActivateUserRequest, opts ...grpc.CallOption) (*RegisterResponse, error)
...
func (c *userServiceClient) Activate(ctx context.Context, in *ActivateUserRequest, opts ...grpc.CallOption) (*RegisterResponse, error) {
	out := new(RegisterResponse)
...
type UserServiceServer interface {
	...
	Activate(context.Context, *ActivateUserRequest) (*RegisterResponse, error)
...
func (UnimplementedUserServiceServer) Activate(context.Context, *ActivateUserRequest) (*RegisterResponse, error) {
...
func _UserService_Activate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).Activate(ctx, req.(*ActivateUserRequest))
	}
	return interceptor(ctx, in, info, handler)
}
